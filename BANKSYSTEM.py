...
def Menu(): 
    ...
    print()
    print("1. Insert Record/Records".center(120))
    print()
    print("2. Display Records as per Account Number".center(120))
    print()
    print(" a. Sorted as per Account Number".center(120))
    print()
    print(" b. Sorted as per Customer Name".center(120))
    print()
    print(" c. Sorted as per Customer Balance".center(120))
    print()
    print("3. Search Record Details as per the account number".center(120))
    print()
    print("4. Update Record".center(120))
    print()
    print("5. Delete Record".center(120))
    print()
    print("6. TransactionsDebit/Withdraw from the account".center(120))
    print()
    print(" a. Debit/Withdraw from the account".center(120))
    print()
    print(" b. Credit into the account".center(120))
    print()
